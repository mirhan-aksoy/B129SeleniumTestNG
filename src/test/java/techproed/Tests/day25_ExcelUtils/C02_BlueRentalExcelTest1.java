...
public class C02_BlueRentalExcelTest1 {
    ...
    public void excelTest() {
        /*
            Eğer bir veriyi(datayı) .properties dosyasından almak istiyorsak,
             ConfigReader classından getProperty()
        methodunu kullanarak .properties dosyamıza kirdiğimiz key değerini belirtiriz
        ve bize buy key değerinin
        value sunu döndürür.
            Eğer bir veriri(datayı) excel dosyasından almak istiyorsak,
            oluşturmuş olduğumuz ExcelUtils class'ındaki
